      ...
      <Container>
        <div className="grid items-center gap-14 md:grid-cols-2 md:gap-16">
          ...
          <Rise index={1} className={flip ? "md:order-1" : undefined}>
            <div className="screen-fit mx-auto">{screen}</div>
          </Rise>
        </div>
      </Container>
    </section>
...
export default function Home() {
  return (
    <div>
      {/* The splash, as it opens on the phone */}
      <section className="flex min-h-[92svh] flex-col">
        <Container className="flex flex-1 flex-col items-center justify-center text-center">
          ...
          <Rise index={1}>
            <h1 className="display mt-8 text-[clamp(4.5rem,17vw,13rem)]">
              Privet
            </h1>
          </Rise>
          <Rise index={2}>
            <div className="rule-double mt-6 w-[min(26rem,72vw)]" />
          </Rise>
          <Rise index={3}>
            <p className="mt-10 max-w-[18ch] font-serif text-[clamp(1.9rem,4.4vw,3.1rem)] italic leading-[1.25] text-ink2">
